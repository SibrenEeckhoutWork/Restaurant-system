          ...
          <section className="contact-grid">
            <div>
              ...
              <dl className="contact-info">
                <div>
                  <dt>Adres</dt>
                  <dd>Stationplein 37<br />8800 Roeselare</dd>
                </div>
                <div>
                  <dt>Bellen</dt>
                  <dd><a href="tel:+32497469065">+32 497 46 90 65</a></dd>
                </div>
                <div>
                  <dt>Mailen</dt>
                  <dd><a href="mailto:hallo@dezoetewever.be">hallo@dezoetewever.be</a></dd>
                </div>
                <div>
                  <dt>Openingsuren</dt>
                ...
                <div>
                  <dt>BTW</dt>
                  <dd style={{ fontStyle: 'normal', fontSize: '1rem', fontFamily: 'var(--mono)', letterSpacing: '0.05em' }}>
                    BE 0795 029 717
                  </dd>
                </div>
              </dl>
            ...
            <div className="visit-grid" style={{ marginTop: '3rem' }}>
              <div className="visit-info">
                ...
                <div style={{ marginTop: '1rem', display: 'flex', gap: '0.75rem', flexWrap: 'wrap' }}>
                  ...
                  <a className="btn btn--ghost" href="/zaaltje">Het zaaltje bekijken</a>
                </div>
              </div>
