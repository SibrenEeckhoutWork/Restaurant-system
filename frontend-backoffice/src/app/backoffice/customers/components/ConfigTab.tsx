...
const CUSTOMER_PERMISSIONS = [
  {
    key: 'customers.read',
    label: 'Lezen',
    description: 'Klanten bekijken — GET /customers en GET /customers/:id',
    color: 'text-blue-700 dark:text-blue-400',
  },
  {
    key: 'customers.create',
    label: 'Aanmaken',
    description: 'Nieuwe klanten aanmaken — POST /customers',
    color: 'text-green-700 dark:text-green-400',
  },
  {
    key: 'customers.update',
    label: 'Bewerken',
    description: 'Klanten bewerken — PATCH /customers/:id',
    color: 'text-yellow-700 dark:text-yellow-400',
  },
  {
    key: 'customers.delete',
    label: 'Verwijderen',
    description: 'Klanten verwijderen — DELETE /customers/:id en bulk',
    ...
    <div className="space-y-4 max-w-2xl">
      ...
      {loading ? (
        ...
        <div className="space-y-2">
          {CUSTOMER_PERMISSIONS.map(({ key, label, description, color }) => (
