...
const RESERVATION_PERMISSIONS = [
  {
    key: 'reservations.get',
    label: 'Bekijken',
    description: 'Reservaties en tijdslots bekijken — GET /reservations, GET /reservations/slots',
    color: 'text-blue-700 dark:text-blue-400',
  },
  {
    key: 'reservations.create',
    label: 'Aanmaken',
    description: 'Reservaties en tijdslots aanmaken — POST /reservations/admin, POST /reservations/slots',
    color: 'text-green-700 dark:text-green-400',
  },
  {
    key: 'reservations.update',
    label: 'Bewerken',
    description: 'Status en tijdslots bewerken — PATCH /reservations/:id/status, PATCH /reservations/slots/:id',
    color: 'text-yellow-700 dark:text-yellow-400',
  },
  {
    key: 'reservations.delete',
    label: 'Verwijderen',
    description: 'Tijdslots verwijderen — DELETE /reservations/slots/:id',
    ...
    <div className="space-y-4 max-w-2xl">
      ...
      {loading ? (
        ...
        <div className="space-y-2">
          {RESERVATION_PERMISSIONS.map(({ key, label, description, color }) => (
