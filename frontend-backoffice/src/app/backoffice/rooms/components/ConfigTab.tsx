...
const ROOM_PERMISSIONS = [
  {
    key: 'rooms.get',
    label: 'Bekijken',
    description: 'Ruimtes bekijken — GET /rooms en GET /rooms/:id',
    color: 'text-blue-700 dark:text-blue-400',
  },
  {
    key: 'rooms.create',
    label: 'Aanmaken',
    description: 'Nieuwe ruimte aanmaken — POST /rooms',
    color: 'text-green-700 dark:text-green-400',
  },
  {
    key: 'rooms.update',
    label: 'Bewerken',
    description: 'Ruimte bewerken — PATCH /rooms/:id',
    color: 'text-yellow-700 dark:text-yellow-400',
  },
  {
    key: 'rooms.delete',
    label: 'Verwijderen',
    description: 'Ruimte verwijderen — DELETE /rooms/:id',
    ...
    <div className="space-y-4 max-w-2xl">
      ...
      {loading ? (
        ...
        <div className="space-y-2">
          {ROOM_PERMISSIONS.map(({ key, label, description, color }) => (
