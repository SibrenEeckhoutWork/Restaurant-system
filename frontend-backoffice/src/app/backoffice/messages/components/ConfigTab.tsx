...
const CONTACT_PERMISSIONS = [
  {
    key: 'contact.read',
    label: 'Lezen',
    description: 'Berichten bekijken — GET /contact',
    color: 'text-blue-700 dark:text-blue-400',
  },
  {
    key: 'contact.update',
    label: 'Gelezen markeren',
    description: 'Bericht als gelezen markeren — PATCH /contact/:id/read',
    color: 'text-yellow-700 dark:text-yellow-400',
  },
  {
    key: 'contact.delete',
    label: 'Verwijderen',
    description: 'Berichten verwijderen — DELETE /contact/:id en bulk',
    ...
    <div className="space-y-4 max-w-2xl">
      ...
      {loading ? (
        ...
        <div className="space-y-2">
          {CONTACT_PERMISSIONS.map(({ key, label, description, color }) => (
